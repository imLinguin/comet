...
|[Homeworld: Deserts of Kharak](https://www.gog.com/en/game/homeworld_deserts_of_kharak)|1.3.0|🔲 Not Available|[`v0.3.0`](https://github.com/imLinguin/comet/releases/tag/v0.3.0)|🟩 Yes|❌ Achievements 🔲 Leaderboard| Achievements don't work, even if Galaxy Communication Service is present. Game has leaderboards, but untested. |
