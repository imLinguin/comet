...
|[DUSK](https://www.gog.com/en/game/dusk)|1.8.25|🟩 Yes|[`v0.3.0`](https://github.com/imLinguin/comet/releases/tag/v0.3.0)|🔲 No|🟩 Achievements 🔲 Leaderboard|Linux version has a bug that causes the game to launch in Chinese, and cannot be changed. This makes testing difficult. Windows version works fine.|
...
|[Heretic + Hexen](https://www.gog.com/en/game/heretic_hexen)|Version 4577-c7e7b84-170 (7/25/2025)|🔲 Not Available|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🔲 Leaderboard|Crossplay multiplayer works.|
|[Homeworld: Deserts of Kharak](https://www.gog.com/en/game/homeworld_deserts_of_kharak)|1.3.0|🔲 Not Available|[`v0.3.0`](https://github.com/imLinguin/comet/releases/tag/v0.3.0)|🟩 Yes|🟩 Achievements 🔲 Leaderboard| Game has buggy achievements that fail to unlock sometimes, even when played on Windows on the official GOG app. Game has leaderboards, but untested. |
...
|[Severed Steel](https://www.gog.com/en/game/severed_steel)|Version 5.5 (2/9/2024)|🔲 Not Available|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🔲 Leaderboard|Achievements work as expected.|
