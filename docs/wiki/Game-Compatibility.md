...
|[Cyberpunk 2077](https://www.gog.com/game/cyberpunk_2077)|2.21 (1/19/2025)|🔲 Not Available|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🔲 Leaderboard|Achievements work in [Heroic v2.16.1](https://github.com/Heroic-Games-Launcher/HeroicGamesLauncher/releases/tag/v2.16.1). This was tested with the regular version of the game, not the [Ultimate Edition](https://www.gog.com/game/cyberpunk_2077_ultimate_edition) or [Phantom Liberty DLC](https://www.gog.com/game/cyberpunk_2077_phantom_liberty).|
...
|[DUSK](https://www.gog.com/game/dusk)|1.8.25|🟩 Yes|[`v0.3.0`](https://github.com/imLinguin/comet/releases/tag/v0.3.0)|🔲 No|🟩 Achievements 🔲 Leaderboard|Linux version has a bug that causes the game to launch in Chinese, and cannot be changed. This makes testing difficult. Windows version works fine.|
|[Flashback](https://www.gog.com/game/flashback)|1.0.0 - 30/11/2018|🔲 Not Available|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🔲 Leaderboard||
...
|[Heretic + Hexen](https://www.gog.com/game/heretic_hexen)|Version 4577-c7e7b84-170 (7/25/2025)|🔲 Not Available|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🔲 Leaderboard|Crossplay multiplayer works.|
|[Homeworld: Deserts of Kharak](https://www.gog.com/game/homeworld_deserts_of_kharak)|1.3.0|🔲 Not Available|[`v0.3.0`](https://github.com/imLinguin/comet/releases/tag/v0.3.0)|🟩 Yes|🟩 Achievements 🔲 Leaderboard| Game has buggy achievements that fail to unlock sometimes, even when played on Windows on the official GOG app. Game has leaderboards, but untested. |
...
|[Indiana Jones and the Great Circle](https://www.gog.com/en/game/indiana_jones_and_the_great_circle)|gog v6 (12/25/2025)|🔲 Not Available|[v0.2.0](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🟩 Yes|🟩 Achievements|Works with the comet version bundled with Heroic Games Launcher 1.18.1.|
...
|[Kingdom Come: Deliverance II](https://www.gog.com/game/kingdom_come_deliverance_ii_gold_edition)|12540_release_1_3_30 (5/29/2025)|🔲 Not Available|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|❓ Unknown|🟩 Achievements 🔲 Leaderboard|Initially, it did not work on Steam Deck running Bazzite. However, when I installed KCD2 on Legion Go running Bazzite, achievements began working. Using Comet bundled with Heroic Games Launcher 2.18.1|
...
|[Severed Steel](https://www.gog.com/game/severed_steel)|Version 5.5 (2/9/2024)|🔲 Not Available|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🔲 Leaderboard|Achievements work as expected.|
...
|[Streets of Rage 4](https://www.gog.com/game/streets_of_rage_4)|Version v08g-r18163 (3/14/2023)|🟩 Yes|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🟩 Leaderboard|Native Linux Version tested: v08g-18208|
...
|[Wolfenstein: The Old Blood](https://www.gog.com/game/wolfenstein_the_old_blood)|1.0 - 06/02/2020|🔲 Not Available|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🔲 Leaderboard||
|[Wonder Boy: The Dragon's Trap](https://www.gog.com/game/wonder_boy_the_dragons_trap)|1.03f.02 - 15/05/2018|❌ Not Working|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🔲 Leaderboard|GOG Galaxy communications are not present in the Linux version. Use Windows version for achievements and cloud save support.|
|[X4: Foundations](https://www.gog.com/en/game/x4_foundations)|Version 8.00 Hotfix 3 - 10/16/2025|❌ Not Working|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🔲 Leaderboard|_(tested on Heroic 2.18.1)_ The game has a working native Linux version, but achievements don't work with it (they work fine on the Windows version). If you're using Heroic, I recommend the Windows version, since it runs just as well if not slightly better, and you get Comet and Cloud Saves support with it (and also: the native Linux and Windows save files are incompatible with one another).|
